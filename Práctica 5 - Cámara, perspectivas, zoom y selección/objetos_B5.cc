...
//*************************************************************************
// dibujar en modo seleccion - Práctica 5
//*************************************************************************
...
void _triangulos3D::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor){
	switch (modo){
		...
		case SELECT:draw_seleccion(r1, g1, b1);break; // Práctica 5
	}
}
	...
	glPushMatrix();
	  // Copa
		glPushMatrix();
			...
			copa.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
		glPopMatrix();
...
void _brazos::brazo1(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor){
	glPushMatrix();
		...
		glPushMatrix();
			...
			mano1.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
		glPopMatrix();
		...
		glPushMatrix();
			...
			codo1.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
		glPopMatrix();
		...
		glPushMatrix();
			...
			biceps1.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
		glPopMatrix();
		...
		glPushMatrix();
			...
			hombro1.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
		glPopMatrix();
	glPopMatrix();
}
...
void _brazos::brazo2(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor){
	...
	// Antebrazos + Muñecas
		...
		glPushMatrix();
			...
			codo2.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
		glPopMatrix();
		...
		glPushMatrix();
			...
			biceps2.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
		glPopMatrix();
		...
		glPushMatrix();
			...
			hombro2.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
		glPopMatrix();
	...
	glPushMatrix();
	  ...
	  glRotatef(60,1,0,0);
		...
		glPushMatrix();
			...
			c1.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
		glPopMatrix();
		...
		glPushMatrix();
			...
			c3.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
		glPopMatrix();

		// Tronco
		glPushMatrix();
			glTranslatef(-0.78,0.15,0.4);
			c2.draw(modo, r1, g1, b1, r2, g2, b2, grosor);
		glPopMatrix();
	glPopMatrix();
}
...
void _mago::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor){
	...
	glPushMatrix();
		...
		glPushMatrix();
			...
			glRotatef(giroCC,0,1,0);
			if(activo[1]==1){
				chistera.draw(modo, r_p, g_p, b_p, r_p, g_p, b_p, grosor);
			}else{
				chistera.draw(modo, r1, g1, b1, 0.6, 0.6, 0.6, grosor);
			}
		glPopMatrix();
		...
		glPushMatrix();
			if(activo[3]==1){
				...
				cuerpo.draw(modo, 0.419608, 0.137255, 0.556863, 1.0, 1.0, 0.0, grosor);
			}
		glPopMatrix();
		...
		glPushMatrix();
			...
			if(activo[6]==1){
				brazos.brazo1(modo, r_p, g_p, b_p, r_p, g_p, b_p, grosor);
			}else{
		...
		glPushMatrix();
			...
			if(activo[7]==1){
				brazos.brazo2(modo, r_p, g_p, b_p, r_p, g_p, b_p, grosor);
			}else{
		...
		glPushMatrix();
			glRotatef(giroB2,1,0,0);
			if(activo[4]==1){
				varita.draw(modo, r_p, g_p, b_p, r_p, g_p, b_p, grosor);
			}else{
		...
		glPushMatrix();
			...
			if(activo[2]==1){
				brillo.draw(modo, r_p, g_p, b_p, r_p, g_p, b_p, grosor);
			}else{
		...
		glPushMatrix();
			if(activo[5]==1){
				piernas.draw(modo, r_p, g_p, b_p, r_p, g_p, b_p, grosor);
			}else{
...
void _mago::seleccion(){
	...
	glPushMatrix();
		...
		c=color_selec[0][1];
		glPushMatrix();
			chistera.draw(SELECT, c, c, c, c, c, c, 1);
		glPopMatrix();

		c=color_selec[0][2];
		glPushMatrix();
			brillo.draw(SELECT, c, c, c, c, c, c, 1);
		glPopMatrix();
		...
		c=color_selec[0][4];
		glPushMatrix();
			varita.draw(SELECT, c, c, c, c, c, c, 1);
		glPopMatrix();

		c=color_selec[0][5];
		glPushMatrix();
			piernas.draw(SELECT, c, c, c, c, c, c, 1);
		glPopMatrix();

		c=color_selec[0][6];
		glPushMatrix();
		  brazos.brazo1(SELECT, c, c, c, c, c, c, 1);
		glPopMatrix();

		c=color_selec[0][7];
		glPushMatrix();
			brazos.brazo2(SELECT, c, c, c, c, c, c, 1);
		glPopMatrix();
	glPopMatrix();
}
